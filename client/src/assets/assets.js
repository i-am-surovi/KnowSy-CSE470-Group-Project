...
import profile_img_4 from "./profile_img4.png";
...
import asifSirImage from "./Asif-Sir.png";
import suroviImage from "./Surovi.png";
import fairuzImage from "./Fairuz.png";
import farihaImage from "./Fariha.png";
import deeanatImage from "./Deeanat.png";
...
export const dummyTestimonial = [
  {
    ...
    rating: 5,
    feedback:
      "Knowsy helped me bridge the gap between theory and practice. I now feel more confident tackling real world coding problems.",
  },
  {
    name: "Carlos Nguyen",
    role: "Software Engineer Intern @ Toronto",
    image: assets.profile_img_2,
    rating: 4.5,
    feedback:
      "The hands-on challenges and mentorship through Knowsy pushed me to actually build things. It’s the best platform I’ve used so far.",
  },
  {
    name: "Meera Patel",
    ...
    rating: 4,
    feedback:
      "What I love most is how Knowsy breaks down complex topics. It’s a great companion to my college courses.",
  },
  {
    name: "Liam Rodriguez",
    role: "Software Engineering Intern @ Startup",
    image: assets.profile_img_4,
    rating: 5,
    feedback:
      "Knowsy gave me the edge I needed to land my first internship. The real-world projects and peer feedback were game-changers.",
  },
];
